...
positiveTokens = np.delete(positiveTokens, 0)

print("Dumping separate corpus into file ...")
...
uniqueWords = np.concatenate((positiveTokens, negativeTokens))
uniqueWords = np.unique(uniqueWords)
uniqueWords.sort()
